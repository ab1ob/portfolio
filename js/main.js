...
const PROJECTS = [
  ...
  },
  {
    ...
    url: "barez.sa",
    link: "https://github.com/ab1ob/barez-erp-overview",
  ...
  },
  {
    ...
    group: "open",
    badge: "CASE STUDY",
    type: "Odoo PoC · activity → impact metrics",
    accent: "blue",
    image: "assets/images/projects/dashboard.png",
    url: "github.com/ab1ob/kpi-impact-odoo-poc",
    link: "https://github.com/ab1ob/kpi-impact-odoo-poc",
    linkKey: "projects.repo",
    desc: "Correcting KPIs from measuring activity to measuring impact — proven live on an Odoo CRM through XML-RPC. Anonymized case study with synthetic data.",
    role: "Methodology & implementation",
    tags: [
      { icon: "odoo", name: "Odoo" },
      { icon: "python", name: "Python" },
      { text: "XML-RPC" },
