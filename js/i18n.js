...
const UI = {
  en: {
    ...
    "hero.scrollCueAria": "Scroll to About",
    ...
    "about.educationValue": "BSc Data Science — Islamic University",
  ...
  ar: {
    ...
    "hero.scrollCueAria": "انزل إلى من أنا",
    ...
    "about.educationValue": "بكالوريوس علم البيانات، الجامعة الإسلامية",
...
const EXPERIENCE_AR = {
  "Barez Company": {
    ...
    date: "فبراير 2026 حتى الآن",
    tags: ["تقنية الموارد البشرية", "إدارة مشاريع"],
    desc: "بدأت استشاري أنظمة موارد بشرية مكلفا بتصميم وتسليم البنية الأساسية في بارز برايم من الصفر: قدت فريقا متعدد التخصصات يجمع الموارد البشرية وتطوير البرمجيات والعمليات لبناء نظام يغطي الركائز السبع كاملة ومتوافق مع نظام العمل السعودي، وسلمته جاهزا للتشغيل خلال أربعة أشهر. نجاح التسليم قاد للتعيين بدوام كامل لقيادة ملف تقنية الموارد البشرية: 4 مشاريع نشطة بالتوازي (نظامان للموارد البشرية وتطبيقان لأنظمة ERP)، ونماذج مؤشرات لست إدارات ساهم نموذج المبيعات منها في رفع الأداء 200%، ودورات تسليم أقصر بإدارة مشاريع منظمة وأتمتة سير العمل.",
    roleSteps: [
      "مدير مشاريع تقنية الموارد البشرية (دوام كامل) · يونيو 2026 حتى الآن",
      "استشاري أنظمة موارد بشرية (تعاقد) · فبراير إلى مايو 2026",
    ],
  ...
  "Research and Consulting Studies Institute, Islamic University": {
    ...
    empType: "تكليف استشاري خارجي",
    tags: ["استشارات", "مؤشرات أداء"],
    desc: "تكليف استشاري خارجي إلى جانب عملي الأساسي: أصحح أكثر من 200 مؤشر أداء لست إدارات تغطي أكثر من 40 موظفا، وأعكسها في لوحات بيانات مؤتمتة داخل نظام أودو.",
    skills: ["تصحيح مؤشرات الأداء", "لوحات أودو", "الأتمتة"],
  },
  "Finsight": {
    role: "أخصائي موارد بشرية أول",
    org: "فينسايت",
    location: "المدينة المنورة",
    date: "يناير 2022 إلى فبراير 2026",
    tags: ["موارد بشرية", "أنظمة موارد بشرية"],
    desc: "قدت تصميم وتطبيق نظام موارد بشرية متكامل مبني على الركائز السبع وموصول بالتقنية للأتمتة والنتائج القابلة للقياس. أسست القسم من الصفر: أكثر من 30 عقد عمل وسياسات وتوافق كامل مع نظام العمل السعودي، وصممت أكثر من 30 مؤشرا مدمجا في Odoo HRMS لمتابعة الأداء لحظيا، وخفضت الدوران تحت 5%، وقدت استقطاب أكثر من 20 وظيفة تخصصية، وأسست وحدة تدريب تعاوني احتضنت أكثر من 10 متدربين، وقدمت أكثر من 50 جلسة إرشاد أداء.",
    skills: ["هندسة أنظمة الموارد البشرية", "تحليلات القوى العاملة", "استقطاب المواهب"],
  },
  "Arees Resort": {
  ...
  "Madinah Society for Community Development": {
    ...
    org: "جمعية المدينة المنورة الأهلية لتنمية المجتمع (مورد المدينة)",
