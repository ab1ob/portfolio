...
const EXPERIENCE_AR = {
  "Barez Company": {
    ...
    desc: "عُينت بدوام كامل لقيادة ملف تقنية الموارد البشرية في بارز برايم بعد تسليم نظام الشركة الأساسي كاستشاري. أقود 4 مشاريع تقنية نشطة بالتوازي: نظامان للموارد البشرية وتطبيقان لأنظمة ERP. بنيت نماذج مؤشرات لست إدارات، وساهم نموذج مؤشرات المبيعات في رفع أداء المبيعات 200%، وقصرت دورات التسليم عبر إدارة مشاريع منظمة وأتمتة سير العمل.",
    skills: ["تسليم أنظمة الموارد البشرية", "نماذج مؤشرات الأداء", "أتمتة سير العمل"],
  },
  "Barez Company (Consultant)": {
    role: "استشاري أنظمة موارد بشرية",
    org: "شركة بارز",
    location: "المدينة المنورة",
    date: "فبراير 2026 إلى مايو 2026",
    tags: ["تعاقد", "أنظمة موارد بشرية"],
    desc: "كلفت بتصميم وتسليم البنية الأساسية للموارد البشرية في بارز برايم من الصفر: قدت فريقا متعدد التخصصات يجمع الموارد البشرية وتطوير البرمجيات والعمليات لبناء نظام يغطي ركائز الموارد البشرية السبع كاملة ومتوافق مع نظام العمل السعودي، وسلمته جاهزا للتشغيل خلال أربعة أشهر، ونجاح المشروع قاد للتعيين بدوام كامل.",
    skills: ["تصميم أنظمة الموارد البشرية", "قيادة فريق", "ملكية المشروع كاملا"],
  },
