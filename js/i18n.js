...
const EXPERIENCE_AR = {
  ...
  "Research and Consulting Studies Institute": {
    role: "استشاري مؤشرات أداء",
    org: "معهد البحوث والدراسات الاستشارية",
    date: "يونيو 2026 حتى الآن",
...
const PROJECTS_AR = {
  ...
  "KPI to Impact": {
    name: "من النشاط إلى الأثر",
    type: "تجربة عملية على Odoo",
    desc: "تصحيح مؤشرات الأداء من قياس النشاط إلى قياس الأثر، مثبت حيا على نظام Odoo عبر XML-RPC. دراسة حالة مجهلة الهوية ببيانات صناعية.",
    role: "منهجية وتنفيذ",
  },
};
